...
- [x] TC-357: Event store read with limit returns the most recent events per product (scenario) — passing
...
- [x] TC-354: Volume snapshot scheduler test passes in full workspace cargo test run (scenario) — passing
